        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Manage your assignments, track your progress, and stay organized with our powerful dashboard designed for students and educators.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Keep track of all your assignments, deadlines, and progress in one organized place.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Access all your course materials, resources, and documents from anywhere.
              </p>
            </div>
